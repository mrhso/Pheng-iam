## 正常部分
### 声母
|IPA|黄锡凌宽式音标|教院式|粤拼|耶鲁式|刘锡祥式|乔砚农式|词儿细译式|黄锡凌罗马拼音|广州式|Penkyamp|范俊军式|荷达谚文（方案一）|
|-|-|-|-|-|-|-|-|-|-|-|-|-|
...
### 韵母
|IPA|黄锡凌宽式音标|教院式|粤拼|耶鲁式|刘锡祥式|乔砚农式|词儿细译式|黄锡凌罗马拼音|广州式|Penkyamp|范俊军式|
|-|-|-|-|-|-|-|-|-|-|-|-|
...
- 范俊军式中，音节 [ʔoŋ]、[ʔok̚]、[joŋ]、[jok̚] 要写成「wung」、「wug」、「yiung」、「yiug」。另外「yi」、「wu」碰到元音字母不要写成「y」、「w」，如「yiung」不写成「yung」。
- 范俊军式「yu」开头的韵母，「yu」可以写成「ü」。

### 声调
|调类|阴阳|IPA|黄锡凌宽式音标|教院式|粤拼|耶鲁式|刘锡祥式|乔砚农式|词儿细译式|黄锡凌罗马拼音|广州式|Penkyamp|范俊军式|
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
